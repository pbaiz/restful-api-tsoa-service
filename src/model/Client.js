...
exports.ClientComplete = void 0;
var ClientComplete = /** @class */ (function () {
    function ClientComplete(pClient) {
        this.username = "";
        this.password = "";
        this.role = "";
        this.firstName = "";
    ...
    ClientComplete.prototype.accept = function (visitor) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, visitor.visite(this)];
